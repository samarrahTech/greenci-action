...
export async function runBootstrap(
  ...
  const createdConfig = ensurePlaywrightConfig(workDir, config.baseUrl, config.testDir);
...
function buildBootstrapPRBody(
  ...
  setup: { installedPlaywright: boolean; createdConfig: boolean; baseUrl: string; testDir: string },
): string {
